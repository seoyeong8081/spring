...
//	@Autowired // 프로퍼티로 autowired 할 때는 final로 선언할 수가 없음, 또한 컴파일 단계에서 순환 참조(A에서 autowired B, B에서 autowired A할 경우 무한루프)를 방지할 수 없음
...
//	@Autowired
	...
	@Autowired // 생성자가 여러개 있을 경우에는 Autowired 설정해주어야함, setter도 똑같음
