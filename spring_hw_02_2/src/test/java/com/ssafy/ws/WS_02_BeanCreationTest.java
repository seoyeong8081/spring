...
//		test.testDataSource();
	...
	@Override
	void testConstruct() {
		bookRepo = context.getBean("bookRepo", BookRepo.class);
		userRepo = context.getBean("userRepo", UserRepo.class);
	...
	@Override
	void testSingleton() {
		BookService bookServiceImpl = context.getBean("bookService", BookService.class);
